...
export const metadata: Metadata = {
  title: "Privacy Policy | Best Bazar",
  description: "Best Bazar privacy policy for Dubai ecommerce customers."
};
        ...
        <div className="mt-8 grid gap-6 text-sm leading-7 text-neutral-700">
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              and improving the Best Bazar storefront.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="mt-2">
              Customers can contact Best Bazar to request access, correction, or deletion of personal data where
